...
Post.create(title: "Post 3", user_id: 2, image: File.open("#{Rails.root}/db/seed_images/posts/post3.jpg"), description: "“It's really hard being average here.”")
...
Post.create(title: "Post 6", user_id: 3, image: File.open("#{Rails.root}/db/seed_images/posts/post6.jpg"), description: "“What do you do?” “I'm a freelance cameraman in Berlin, where I work for TV and shoot films. It’s my passion. I love telling stories and I get to travel.” “What makes you happy?” “The freedom to do what I want to do.”")

Post.create(title: "Post 7", user_id: 3, image: File.open("#{Rails.root}/db/seed_images/posts/post7.jpg"), description: "“I like to invent stories for people. For example, that girl. She’s probably an MCB major, and now she’s trying to untangle her earphones and hates the fact that they are tangled. She keeps thinking in her head 'Why are they always tangled?' That other girl, she looks like she is in a sorority, but she also might not be, who knows? So many wonderful lives. It’s so interesting to imagine. And that guy is an international spy, but no one knows his identity.”")
